...
package
{
	import com.distriqt.test.promotionunlocker.Main;
	...
	/**	
	 * Sample application for using the ProMotionUnlocker Native Extension
	 */
	public class TestProMotionUnlocker extends Sprite
	{
		////////////////////////////////////////////////////////
		//	CONSTANTS
		//
		 ...
		 *  Constructor
		 */
		public function TestProMotionUnlocker()
		{
			super();
			if(this.stage)
			{
